...
<template>
  ...
  <a-trigger v-else class="f_nav_avatar_trigger"
             animation-name="fade" trigger="hover" :unmount-on-close="false">
    ...
    <template #content>
      <div class="f_nav_avatar_com">
        ...
        <div class="data">
          <router-link :to="{name: 'userFansList', params: {id: store.userInfo.userID}}">
            <a-statistic extra="粉丝" :value="store.userInfo.fansCount"/>
          </router-link>
          <router-link :to="{name: 'userFocusList', params: {id: store.userInfo.userID}}">
            <a-statistic extra="关注" :value="store.userInfo.followCount"/>
          </router-link>
          <router-link :to="{name: 'userArticle', params: {id: store.userInfo.userID}}">
