...
import type {categoryListType} from "@/api/category_api";
...
<template>
  <div class="f_category_list_com">
    ...
    <f_collect_form_modal v-if="props.isMe" @ok="getCollectData" :id="form.id" v-model:title="form.title"
                          v-model:abstract="form.abstract" v-model:visible="visible"></f_collect_form_modal>
    <div class="list">
