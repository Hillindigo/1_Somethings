      ...
      <div class="user_info">
        ...
        <div class="actions">
          <template v-if="baseStore.userBase.userID != store.userInfo.userID">
            ...
            <f_a @click="goChat(baseStore.userBase.userID)">
      ...
      <div class="user_sub_view">
        <div class="head">
          <div class="left">
            ...
            <router-link :to="{name: 'userArticleCollect', query: {collectID: -1}}" v-if="baseStore.isMe || baseStore.userBase.openCollect"
            >{{ baseStore.isMe ? '我的收藏' : '他的收藏' }}
            </router-link>
            <router-link :to="{name: 'userFocusList'}" v-if="baseStore.isMe || baseStore.userBase.openFollow">
              {{ baseStore.isMe ? '我的关注' : '他的关注' }}
            </router-link>
            <router-link :to="{name: 'userFansList'}" v-if="baseStore.isMe || baseStore.userBase.openFans">
