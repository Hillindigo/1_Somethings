...
async function handleSelect(id: number, v:  string | number | Record<string, any> | undefined) {
    ...
    <div class="head">
      <div class="left">
        ...
        <router-link :to="{name: 'platformArticleAdd'}">
          <a-button :disabled="(store.siteInfo.siteInfo.mode === 2 && !store.isAdmin)" type="primary">发布文章</a-button>
        </router-link>
      </div>
      <div class="right">
