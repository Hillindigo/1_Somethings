...
import type {siteResponse} from "@/api/site_api";
const version = JSON.parse(import.meta.env.VITE_GIT_INFO).version
</script>
            ...
            <div class="form site_form">
              ...
              <div class="body">
                <a-form-item :label-col-props="{span: 4}" :wrapper-col-props="{span: 18}" label="网站标题">
                  ...
                  <template #help>左上角logo旁边的文字，默认是枫枫知道，建议四个字</template>
                </a-form-item>
                <a-form-item :label-col-props="{span: 4}" :wrapper-col-props="{span: 18}" label="英文名称">
                  <a-input placeholder="英文网站标题" v-model="form.siteInfo.enTitle"></a-input>
                  <template #help>左上角logo旁边的文字，默认是fengfengzhidao，建议14个英文字母</template>
                </a-form-item>
                <a-form-item :label-col-props="{span: 4}" :wrapper-col-props="{span: 18}" label="slogan">
                  <a-input placeholder="slogan" v-model="form.siteInfo.slogan"></a-input>
                  <template #help>首页的slogan名称，默认是Blogx</template>
                </a-form-item>
            ...
            <div class="form about_form">
              ...
              <div class="body">
                ...
                <a-form-item :label-col-props="{span: 4}" :wrapper-col-props="{span: 18}" label="qq二维码">
                  <f_image_upload :width="100" :height="100" shape="square" v-model="form.about.qq" placeholder="qq二维码地址"></f_image_upload>
                </a-form-item>
                <a-form-item :label-col-props="{span: 4}" :wrapper-col-props="{span: 18}" label="微信二维码">
                  <f_image_upload shape="square" v-model="form.about.wechat" :width="100" :height="100"
